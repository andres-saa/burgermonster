    ...
    <div class="section-logo section">
      <div class="section-logo--buttons">
        <img style="cursor: pointer;" @click="router.push('/')" :class="route.fullPath == '/menu' ? 'logo2' : 'logo'"
          src="https://backend.salchimonster.com/read-photo-product/mm9Ohnu7" alt="Logo" />
      </div>
...
const socialLinks = [
  ...
  {
    icon: 'pi pi-whatsapp',
    href: 'https://api.whatsapp.com/send?phone=573332399085'
  },
...
const estilosPorRuta = {
  ...
  '/sedes': 'barra-sedes',
  '/menu': 'barra-oscura',
  '/rastrear-pedido': 'barra-oscura',
  '/franquicias': 'barra-oscura',
