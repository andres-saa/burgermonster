<template>
    ...
    <div class="container shadow-3 col-12" style="border-radius: 0.5rem; height: 100%;position: relative;background-color: white;">
        ...
        <Button style="position: absolute;background-color: black;border: none; right: -1rem; top:-1rem;" @click="addToCart(props.product)" severity="danger"
