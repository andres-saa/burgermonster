...
<!--       
  ...
  <img style="width:15vw;" v-for="character in [1,2,3,4,5]" :src="`/images/characters/closed.png`" alt="">
  ...
  <p class="text-center text-3xl col-12 text-white" style="font-weight: bold;display: flex;gap: 1rem;align-items: center;">
    ...
    PROMOCIONES
      ...
      <div v-for="(product, index) in products?.filter(d => d.categoria_id == 22)" :key="product.id" class=" col-12   md:col-4 lg:col-3 sm:col-6">
